...
const YTDLP_BIN = path.join(__dirname, '..', 'bin', 'yt-dlp_macos');
...
const DL_ARGS = ['-f', 'bestaudio[ext=m4a]/bestaudio[ext=webm]/bestaudio', '--no-playlist', '--no-progress', '--print-json'];
